...
<head>
    ...
    var_dump((int)'012345'); // Почему 12345?  Приведение к числу, ноль отбрасывается
    var_dump((float)123.0 === (int)123.0); // Почему false? Строгое равенство, разные типы данных.
